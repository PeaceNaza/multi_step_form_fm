...
const Button = ({ children, variant, onClick, isActive, isCompleted }) => {
  ...
  const variantStyle = {
    ...
    secondary: ` rounded-[50%] font-semibold px-2.5 py-1.5 text-xs ${isCompleted ? " bg-primary-400 text-primary-100" : "bg-primary-200 text-white border"} ${isActive ? " bg-primary-400 text-primary-100" : "bg-primary-200 text-white border"}`,
